    ...
    data: function() {
      return {
        ...
        chartOptions: { 
          ...
          xaxis: {
            categories: [1992, 1992, 1993, 1994, 1995, 1996, 1997, 1998, 1998, 1998, 1998, 1998]
          }
        },
        series: [{
          name: "Quilometragem total por dia",
          data: [30, 40, 35, 50, 49, 60, 70, 91, 91, 91, 91, 91, 30, 40, 35, 50, 49, 60, 70, 91, 91, 91, 91, 91, 91, 91, 91, 91, 91]
        },
        {
   ...
   watch: {
      TotalKm(n) {
        ...
        this.chartOptions = { ...this.chartOptions, series :[{
          name: "Quilometragem total por dia",
          data: [
              (this.DadostotalKm[0].finalKm - this.DadostotalKm[0].initialKm)+
              (this.DadostotalKm[1].finalKm - this.DadostotalKm[1].initialKm),
              (this.DadostotalKm[2].finalKm - this.DadostotalKm[2].initialKm)+
              (this.DadostotalKm[3].finalKm - this.DadostotalKm[3].initialKm),
              (this.DadostotalKm[4].finalKm - this.DadostotalKm[4].initialKm)+
              (this.DadostotalKm[5].finalKm - this.DadostotalKm[5].initialKm),
              (this.DadostotalKm[6].finalKm - this.DadostotalKm[6].initialKm)+
              (this.DadostotalKm[7].finalKm - this.DadostotalKm[7].initialKm),
              (this.DadostotalKm[8].finalKm - this.DadostotalKm[8].initialKm)+
              (this.DadostotalKm[9].finalKm - this.DadostotalKm[9].initialKm),
              (this.DadostotalKm[10].finalKm - this.DadostotalKm[10].initialKm) +
              (this.DadostotalKm[11].finalKm - this.DadostotalKm[11].initialKm),
              (this.DadostotalKm[12].finalKm - this.DadostotalKm[12].initialKm) +
              (this.DadostotalKm[13].finalKm - this.DadostotalKm[13].initialKm),
              (this.DadostotalKm[14].finalKm - this.DadostotalKm[14].initialKm) +
              (this.DadostotalKm[15].finalKm - this.DadostotalKm[15].initialKm),
              (this.DadostotalKm[16].finalKm - this.DadostotalKm[16].initialKm) +
              (this.DadostotalKm[17].finalKm - this.DadostotalKm[17].initialKm),
              (this.DadostotalKm[18].finalKm - this.DadostotalKm[18].initialKm) +
              (this.DadostotalKm[19].finalKm - this.DadostotalKm[19].initialKm),
              (this.DadostotalKm[20].finalKm - this.DadostotalKm[20].initialKm) +
              (this.DadostotalKm[21].finalKm - this.DadostotalKm[21].initialKm),
              (this.DadostotalKm[22].finalKm - this.DadostotalKm[22].initialKm) +
              (this.DadostotalKm[23].finalKm - this.DadostotalKm[23].initialKm),
              (this.DadostotalKm[24].finalKm - this.DadostotalKm[24].initialKm) +
              (this.DadostotalKm[25].finalKm - this.DadostotalKm[25].initialKm),
              (this.DadostotalKm[26].finalKm - this.DadostotalKm[26].initialKm) +
              (this.DadostotalKm[27].finalKm - this.DadostotalKm[27].initialKm),
              (this.DadostotalKm[28].finalKm - this.DadostotalKm[28].initialKm) +
              (this.DadostotalKm[29].finalKm - this.DadostotalKm[29].initialKm)
          ...
          data: [
            ...
            (this.DadostotalKm[18].finalKm - this.DadostotalKm[18].initialKm) + (this.DadostotalKm[19].finalKm - this.DadostotalKm[19].initialKm) /  2,
            (this.DadostotalKm[20].finalKm - this.DadostotalKm[20].initialKm) + (this.DadostotalKm[21].finalKm - this.DadostotalKm[21].initialKm) /  2,
            (this.DadostotalKm[22].finalKm - this.DadostotalKm[22].initialKm) + (this.DadostotalKm[23].finalKm - this.DadostotalKm[23].initialKm) /  2,
            (this.DadostotalKm[24].finalKm - this.DadostotalKm[24].initialKm) + (this.DadostotalKm[25].finalKm - this.DadostotalKm[25].initialKm) /  2,
            (this.DadostotalKm[26].finalKm - this.DadostotalKm[26].initialKm) + (this.DadostotalKm[27].finalKm - this.DadostotalKm[27].initialKm) /  2,
            (this.DadostotalKm[28].finalKm - this.DadostotalKm[28].initialKm) + (this.DadostotalKm[29].finalKm - this.DadostotalKm[29].initialKm) /  2,
          ]
        },
        {
          name: "Valor total das multas por dia",
          data: [
            ...
            (this.DadostotalKm[16].finesTotalAmount + this.DadostotalKm[17].finesTotalAmount),
            (this.DadostotalKm[18].finesTotalAmount + this.DadostotalKm[19].finesTotalAmount),
            (this.DadostotalKm[20].finesTotalAmount + this.DadostotalKm[21].finesTotalAmount),
            (this.DadostotalKm[22].finesTotalAmount + this.DadostotalKm[23].finesTotalAmount),
            (this.DadostotalKm[24].finesTotalAmount + this.DadostotalKm[25].finesTotalAmount),
            (this.DadostotalKm[26].finesTotalAmount + this.DadostotalKm[27].finesTotalAmount),
            (this.DadostotalKm[28].finesTotalAmount + this.DadostotalKm[29].finesTotalAmount),
          ]
        }
        ]};
