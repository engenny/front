...
export default {
    ...
    data: function() {
      return {
        ...
        series: [{
          name: 'Valor das multas por dia',
          data: [30, 40, 35, 50, 49, 60, 70, 91, 91, 91, 91, 91]
        }]
      }
    },
    created() {
   ...
   watch: {
      TotalKm(n) {
        ...
        //  this.chartOptions = { ...this.chartOptions,series :{ data: [this.DadostotalKm.map((v)=>{ return v.id })]}};
      },
    },
    methods: {
